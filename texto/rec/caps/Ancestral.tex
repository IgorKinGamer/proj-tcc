...
O ID de um nó é formado por um ou mais \textit{bits} seguidos do ID do seu pai, de modo que, dados dois nós \no{a} e \no{b}, \no{b} descendente de \no{a},
os \textit{bits} menos significativos de \no{b} são iguais ao ID de \no{a}.
Desse modo, dados dois descendentes de um nó \no{c}, todos os \textit{bits} menos significativos deles que coincidem
